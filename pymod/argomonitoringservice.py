...
class Period(object):
    ...
    """
    def __init__(self, startDate: Union[datetime, str], endDate: Union[datetime,str]=None, granularity="daily"):
        ...
        if endDate is None:
            self._endDate = self._startDate.replace(hour=23, minute=59, second=59, microsecond=0)
        else:
